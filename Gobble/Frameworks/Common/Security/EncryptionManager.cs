...
{
    /// <summary>
    /// Component handles encryption request specifically dealing with private key encryptions 
    /// using Triple-DES
    /// </summary>
    public class EncryptionManager
    {
        ...
        public string DefaultDecryption(string cypherText)
        {
            if (string.IsNullOrEmpty(cypherText))
                throw new ArgumentException("Invalid value for the cypher text. Value can not be empty for the encryption.");

            return this.Decrypt(cypherText, EncryptionManager.Settings.EncryptPassPhrase,
                                EncryptionManager.Settings.EncryptSaltValue,
                                EncryptionManager.Settings.EncryptHashAlgorithm,
                                EncryptionManager.Settings.EncryptPassIterations,
                                EncryptionManager.Settings.EncryptInitVector, 256);
        }
        ...
        public string DefaultEncryption(string plainText)
        {
            ...
            return this.Encrypt(plainText, EncryptionManager.Settings.EncryptPassPhrase,
                                EncryptionManager.Settings.EncryptSaltValue,
                                EncryptionManager.Settings.EncryptHashAlgorithm,
                                EncryptionManager.Settings.EncryptPassIterations,
                                EncryptionManager.Settings.EncryptInitVector, 256);
